...
export type AllergySeverity = 'mild-intolerance' | 'moderate-intolerance' | 'severe-allergy';
...
export const ALLERGY_SEVERITIES: { value: AllergySeverity; label: string; description: string }[] = [
  { 
