  ...
  return (
    <div className="card">
      ...
      <p className="text-gray-600 mb-4">
        Add any additional information about meal preferences, dietary restrictions, or special considerations.
      </p>

      {/* Quick examples */}
      <div className="mb-4">
        <h3 className="text-sm font-medium text-gray-700 mb-2">Quick Add Common Instructions:</h3>
        <div className="flex flex-wrap gap-2">
          {exampleInstructions.map((example, index) => (
            <button
              ...
              disabled={!validateMaxLength(localInstructions + `\n• ${example}`, MAX_LENGTH)}
            >
              + {example}
            </button>
          ))}
      ...
      <div id="instructions-help" className="mt-3 text-sm text-gray-600">
        <p className="mb-2"><strong>Examples of helpful information:</strong></p>
        <ul className="list-disc list-inside space-y-1 text-xs">
          <li><strong>Texture:</strong> "Prefers soft foods" or "Needs pureed consistency"</li>
          <li><strong>Temperature:</strong> "Enjoys warm meals" or "Prefers room temperature drinks"</li>
          <li><strong>Cultural/Religious:</strong> "Halal requirements" or "No pork products"</li>
          <li><strong>Medical:</strong> "Low sodium diet" or "Diabetic-friendly portions"</li>
          <li><strong>Behavioral:</strong> "Eats better with familiar caregivers" or "Prefers quiet dining environment"</li>
        </ul>
      </div>
      ...
      {!isValid && (
        <div className="mt-3 p-3 bg-red-50 border border-red-200 rounded-lg">
          <p className="text-red-700 text-sm">
            ⚠️ Instructions exceed the {MAX_LENGTH} character limit. Please shorten your text.
          </p>
        </div>
      )}
      ...
      {localInstructions.trim() && (
        <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
          <h4 className="text-sm font-medium text-blue-800 mb-2">Instructions Summary:</h4>
